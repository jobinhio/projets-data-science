...
\begin{figure}[htbp]
    ...
    \node (fusion) at (0,0) {\includegraphics[width=5cm,height=3cm]{Images/coule HWS.jpg}};
    \node[below] at (fusion.south) {Fours de Fusion}; % Title below the node

    % Other nodes and labels
    \node (cabine) at (2,-5) {\includegraphics[width=5cm,height=3cm]{Images/coule HWS.jpg}};
    \node[below] at (cabine.south) {Cabine de Fil fourré};

    \node (coulee) at (12,-5) {\includegraphics[width=5cm,height=3cm]{Images/coule HWS.jpg}};
