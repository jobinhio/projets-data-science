...
\node (fusion) at (0,0) {\includegraphics[width=3cm,height=2cm]{Images/coule.jpg}};
\node[below] at (fusion.south) {Fours de Fusion};

% Other nodes and labels (adjust image dimensions)
\node (cabine) at (3,-3) {\includegraphics[width=3cm,height=2cm]{Images/coule.jpg}};
\node[below] at (cabine.south) {Cabine de Fil fourré};

\node (coulee) at (6,-3) {\includegraphics[width=3cm,height=2cm]{Images/coule.jpg}};
\node[below] at (coulee.south) {Poche de Coulée};

\node (Fours) at (9,-3) {\includegraphics[width=3cm,height=2cm]{Images/coule.jpg}};
\node[below] at (Fours.south) {Fours de Coulée};

\node (Moulage) at (12,-3) {\includegraphics[width=3cm,height=2cm]{Images/coule.jpg}};
...
\begin{figure}[htbp]
    ...
    \node (fusion) at (0,0) {\includegraphics[width=5cm,height=3cm]{Images/coule.jpg}};
    \node[below] at (fusion.south) {Fours de Fusion}; % Title below the node

    % Other nodes and labels
    \node (cabine) at (2,-5) {\includegraphics[width=5cm,height=3cm]{Images/coule.jpg}};
    \node[below] at (cabine.south) {Cabine de Fil fourré};

    \node (coulee) at (12,-5) {\includegraphics[width=5cm,height=3cm]{Images/coule.jpg}};
